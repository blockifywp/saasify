...
<div class="wp-block-group alignfull is-style-default has-16-font-size" style="margin-top:0;padding-top:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--md)"><!-- wp:spacer {"height":"","style":{"position":{"all":"absolute"},"top":{"all":"0px"},"right":{"all":"0px"},"bottom":{"all":"0px"},"left":{"all":"0px"},"zIndex":{"all":"-1"},"pointerEvents":{"all":"none"}},"align":"full","gradient":"background-transparent-blur"} -->
